      ...
      <div className='flex flex-col'>
        ...
        <form action="" className='border-2 p-4 rounded-2xl my-4'>
          <div className='flex flex-col space-y-3 mb-8'>
            ...
            <input className='text-center rounded-xl py-1 max-w-xl text-2xl hover:bg-slate-600' onChange={updateNumero} type="text" placeholder={`${numero}`} />
          </div>
          <div className='flex flex-col space-y-3 mb-6'>
            ...
            <div className='flex space-x-6'>
              <button type='submit' className='hover:scale-105 bg-white grow text-black font-bold rounded-xl max-w-fit self-center'>Convertir </button>
              <p className='bg-white grow px-4 self-center rounded-2xl py-1 text-black text-2xl'>{resultado}</p>
            </div>
          </div>
        </form>
        <a className='flex items-center justify-center' href='https://github.com/andrescn20/convertidor-bases'>
          <p className='mx-2'>
            andrescn20
          </p>
